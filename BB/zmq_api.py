...
class zmq_api(DWX_ZMQ_Strategy):
    ...
    def run(self):        
        ...
        for s in self._symbols:
            ...
            #self.ea.append(EA_BB(sb_obj self,self.obj_input,30))
            self.obj_input.timeframe=60
            self.ea.append(EA_BB(sb_obj, self,self.obj_input))
            self.obj_input.timeframe=240
            self.ea.append(EA_BB(sb_obj, self,self.obj_input))
            self.obj_input.timeframe=1440
            self.ea.append(EA_BB(sb_obj, self,self.obj_input))
        ...
        self.line.send_Line_msg("BB EA Started...")
...
#   example = zmq_api([32768,32769,32770],BB_input())  
